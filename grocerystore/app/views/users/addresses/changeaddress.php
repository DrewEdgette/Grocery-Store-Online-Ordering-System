...
<?php echo "<form method='post' action='/grocerystore/users/changeaddress?id=" . $_GET["id"] . "'>";?>
...
<div class="goto-signup">
        <?php echo "<a href='/grocerystore/users/deleteaddress?id=" . $_GET["id"] . "'><button>Delete address</button></a>"; ?>
    </div>
